      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 182 36" >
        ...
        <defs>
          <linearGradient id="a" x1="50%" x2="50%" y1="0%" y2="100%">
            <stop stopColor="#9AC4FA" offset="0%" />
            <stop stopColor="#669FEA" offset="100%" />
          </linearGradient>
          <linearGradient id="b" x1="3.26%" y1="2.81%" y2="86.22%">
            <stop stopColor="#84B0E9" offset="2.29%" />
            <stop stopColor="#6895CF" offset="100%" />
          </linearGradient>
        </defs>
        <g fill="none" fillRule="evenodd">
          ...
          <path fill="#000" fillOpacity=".15" d="M9 36v-9l-5-5" />
        </g>
      </svg>
    </Wrapper>
  );
